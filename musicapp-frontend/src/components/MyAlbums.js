  ...
  return (
    <div className={styles.try}>
      <div className={styles.myalbum + " row"}>
        ...
        <h5 className="font-monospace text-center fst-italic text-light">
          The home of sharing music. Enjoy a steady flow of great hit music
        </h5>
        <Link
          className={
            styles.link + " " + styles.text + " text-center" + " fw-bold fs-5"
          }
          to="/addalbum"
        >
          {" "}
                    ...
                    <div className={styles.cardbox + " mb-4 "}>
                      <div className={styles.pcontainer}>
                        <img
                          src={url + album.cover}
                          alt="Pics"
                          className={"card-img-top " + styles.albumpic}
                          width="200"
                          height="200"
                        />
                        <Link
                          className={styles.link}
                          to={"/myalbum/" + album._id}
                        >
                          <div className={styles.middle}>
                            <div className={styles.clickalbum}>
                              {album.title}
                            </div>
                          </div>
                        </Link>
                      ...
                      <div className="card-body p-1 ">
                        <div className="row mx-0">
                          <h5 className="card-title text-dark col mb-0 align-middle mt-3 ms-0">
                            {album.title}
                          </h5>
                          <button
                            type="button"
                            title="Delete"
                            className={
                              "btn  btn-light col-2  fw-normal " + styles.btndel
                            }
                            onClick={() => {
